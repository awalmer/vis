...
<div class="card" style="width: fit-content;">
    <div id="heatmap-responsive" style="display: flex; justify-content: start; align-items: top;">
        <div style="min-width: 70%;">
            ...
            <h3 style="margin-top: 5px;">2006 to 2025 ('07 and '09 not included)</h3>
            ...
            <h1 style="font-size: 1.4em; margin-top: 15px;">Select Region: ${inputViz}</h1>
